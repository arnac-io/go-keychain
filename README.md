...
[![Build Status](https://github.com/arnac-io/go-keychain/actions/workflows/ci.yml/badge.svg)](https://github.com/arnac-io/go-keychain/actions)
...
```go
import "github.com/arnac-io/go-keychain"
```
